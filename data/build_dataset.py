...
def main():
    interactions = pd.read_csv('actions.csv',sep=';', decimal=',', encoding='windows-1251')
    print('Original data:')
    ...
    print('Write to disk')
    # write to disk
    os.makedirs('last-session-out')
    train_full_sessions.to_hdf('last-session-out/sessions.hdf','train')
    test_sessions.to_hdf('last-session-out/sessions.hdf','test')
    train_valid_sessions.to_hdf('last-session-out/sessions.hdf', 'valid_train')
    valid_sessions.to_hdf('last-session-out/sessions.hdf','valid_test')
